...
.avatar-image-box {
  ...
  box-shadow: 0 8px 16px rgba(0, 45, 107, 0.04);
...
.avatar-orbit-ring {
  ...
  right: -6px;
  bottom: -6px;
  border: 2px dashed rgba(0, 71, 165, 0.15);
  border-radius: 50%;
  z-index: 1;
...
.team-card:hover .avatar-image-box {
  border-color: #0047A5;
}

.team-card:hover .avatar-orbit-ring {
  border-color: #FFC700;
  border-style: solid; 
